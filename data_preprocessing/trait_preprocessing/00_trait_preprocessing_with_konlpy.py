...
if __name__ == "__main__":
    ...
    files_to_process = [
        # 입양 Y 유기견 데이터
        ("../../resource/final_adopted_data.csv", "../../resource/trait_preprocessed_data/trait_adopted_preprocessing.csv"),
        # 입양 N 유기견 데이터
        ("../../resource/final_unadopted_data.csv", "../../resource/trait_preprocessed_data/trait_unadopted_preprocessing.csv")
    ]
