...
2. 📜 [데이터 전처리 및 분석 파일 설명](#-데이터-전처리-및-분석-파일-설명)  
   - [데이터 병합 및 기본 전처리](#1-데이터-병합-및-기본-전처리)  
   - [농림 데이터 전처리](#2-농림-데이터-전처리)  
   - [서울 데이터 전처리](#3-서울-데이터-전처리)  
   - [네이버 카페 데이터 전처리](#4-네이버-카페-데이터-전처리)  
   - [입양 여부별 데이터 분리](#5-입양-여부별-데이터-분리)  
   - [GPT를 활용한 텍스트 전처리](#6-gpt를-활용한-텍스트-전처리)  
   - [Konlpy를 활용한 특징 및 종 데이터 전처리](#7-konlpy를-활용한-특징-및-종-데이터-전처리)  
   - [특징 데이터 샘플링 및 정렬](#8-특징-데이터-샘플링-및-정렬)  
3. ✨ [문서 목적](#-문서-목적)
